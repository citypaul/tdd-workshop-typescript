...
```bash
pnpm start:lab3       # switch to the Lab 3 starting checkpoint
...
This is the front-end version of "tests as executable specifications": a query
by role, label, name, status, or description is specifying how the product is
exposed to users and assistive technology.
